...
const Theme = () => {
  ...
  return (
    ...
    <MenubarMenu>
      ...
      >
        {mode==='light'?(<Image  className='active-theme' width={20}  height={20}src="/assets/icons/sun.svg" alt='sun'/>):(<Image className='active-theme'  width={20}  height={20}src="/assets/icons/moon.svg" alt='moon'/>)}
      </MenubarTrigger>
